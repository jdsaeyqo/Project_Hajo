...
import com.ssafy.hajo.databinding.DialogWinwinBinding
import com.ssafy.hajo.entity.Match
import java.lang.Math.sqrt

class WinwinDialog(context: Context, match: Match, private val rollCallback: (String, Int) -> Unit): Dialog(context), SensorEventListener {
    lateinit var binding: DialogWinwinBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogWinwinBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        ...
        binding.cvRoulette.setOnClickListener {
            ...
            oa.start()
            binding.roulette.setPercent(50)
        }
    }
