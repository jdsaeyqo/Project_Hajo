...
import com.ssafy.hajo.databinding.DialogLoseBinding
import com.ssafy.hajo.entity.Match
import java.lang.Math.sqrt

class LoseDialog(context: Context, match: Match, private val callback: (Int) -> Unit): Dialog(context) {
    lateinit var binding: DialogLoseBinding
